        ...
        <div className="flex flex-col lg:flex-row gap-6 px-8 mt-2 py-8 max-w-[1280px] h-[473px] mx-auto">
            ...
            <div className="lg:w-[65%] w-full bg-white border border-[#B0B0B0] p-4 flex flex-col lg:flex-row">
                ...
                <div className="w-full lg:pl-6 flex flex-col justify-center lg:w-[50%]">
                    <h2 className="text-[24px] font-semibold mb-2">End to End development</h2>
                    <p className="text-[16px] text-[#5D5D5D] leading-relaxed">
                        We empower you to launch a fully customized live streaming platform
                        without any coding expertise. Utilizing advanced no-code technologies,
                        we handle everything from design to deployment, ensuring your platform
                        is user-friendly, scalable, and tailored to your brand. Whether you’re
                        aiming for live broadcasts, on-demand content, or interactive features,
                        we deliver a seamless solution that brings your vision to life.
                    </p>
                </div>
            </div>
            ...
            <div className="lg:w-[30%] w-full bg-white  border border-[#B0B0B0] p-4 flex flex-col">
                ...
                <div className="text-center lg:text-left">
                    <h2 className="text-[24px] font-semibold mb-1">Mobile App Development</h2>
                    <p className="text-[16px] text-[#5D5D5D] leading-relaxed">
